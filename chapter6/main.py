...
@app.get("/")
async def root():
    return {"message": "API health check successful: status succesfull"}
...
@app.get("/v0/players/{player_id}", summary='Get one player using Player ID', response_model=schemas.Player, tags=['Player'])
